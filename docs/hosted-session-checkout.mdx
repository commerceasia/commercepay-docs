...
<Steps>
  ...
  <Step title="Initiate Session Request">
    The merchant backend calls the [Hosted Session Checkout](/api-reference/initial-session) endpoint to create a payment session for the order. Upon success, CommercePay returns a session URL for the hosted payment page.
  </Step>
